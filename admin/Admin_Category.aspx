<%@ Page Title="Question Section Management" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true"
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Q Section Management</li>
                </ul>
                <!--/.breadcrumb -->
            </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="btn-colum">
                                        <asp:LinkButton ID="lnk_Add_Question" runat="server" class="btn btn-inverse text-right"
                                            CausesValidation="False" OnClick="linkAdd_Click">Add Q Section</asp:LinkButton>
                                    </div>
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <span>
                                                            <asp:Label ID="lbl_CategoryName" runat="server" Text='<%# Eval("CategoryName") %>'></asp:Label></span>
                                                    </td>
                                                    <td>
                                                        <div class="hidden-sm hidden-xs btn-group">
                                                            <asp:Label ID="lbl_Id" runat="server" Visible="false" Text='<%# Eval("CategoryId") %>'></asp:Label>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row text-center admin-stream">
                            ...
                            <div class="col-md-12 add-stream">
                                <h1>
                                  Question Section Management</h1>
