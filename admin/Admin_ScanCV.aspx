<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Admin_ScanCV.aspx.cs" Inherits="admin_Admin_ScanCV" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                 <span>
                                                        <asp:Label ID="lbl_CVUrl" Visible="false" runat="server" Text='<%# Eval("Resume_Url") %>'></asp:Label></span>
                                                        <asp:LinkButton ID="lnk_ViewCV" class="btn btn-sm btn-info" runat="server" CommandName="ViewCV" Text="View All"></asp:LinkButton>
                                                    </span>    
                                                </td>
                                            </tr>
                                    </ItemTemplate>
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row text-center admin-stream">
                            ...
                            <h1>
                                    Candidate Resume</h1>
                                <asp:LinkButton ID="lnk_Back3" class="btn btn-inverse" runat="server" OnClick="lnk_Back3_Click">Back</asp:LinkButton>
                               
                              <asp:Label ID="ltEmbed" Width="100%" runat="server" Text=""></asp:Label>
