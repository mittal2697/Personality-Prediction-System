<%@ Page Title="" Language="C#" MasterPageFile="~/Inner.master" AutoEventWireup="true"
    CodeFile="PostResume.aspx.cs" Inherits="PostResume" %>
                                                ...
                                                <div class="main-block">
                                                    ...
                                                    <div class="sub-block">
                                                        ...
                                                        <div class="profile-info-row">
                                                            ...
                                                            <div class="profile-info-value">
                                                                <asp:DropDownList ID="ddl_StatePersonal" runat="server" 
                                                                    class="col-xs-12 col-sm-6" AutoPostBack="True"
                                                                    OnSelectedIndexChanged="ddl_State_SelectedIndexChanged">
                                                                    <asp:ListItem Enabled="true" Text="Select State" Value=""></asp:ListItem>
                                                                </asp:DropDownList>
                                                                <asp:RequiredFieldValidator ID="txtRequiredState" runat="server" ControlToValidate="ddl_StatePersonal"
                                                        ...
                                                        <div class="profile-info-row">
                                                            ...
                                                            <div class="profile-info-value">
                                                                <asp:DropDownList ID="ddl_CityPersonal" runat="server" 
                                                                    class="col-xs-12 col-sm-6">
                                                                    
                                                                </asp:DropDownList>
                                                                <asp:RequiredFieldValidator ID="txtRequiredCity" runat="server" ControlToValidate="ddl_CityPersonal"
                                                    ...
                                                    <div class="sub-block">
                                                        ...
                                                        <div class="profile-info-row">
                                                            ...
                                                            <div class="profile-info-value">
                                                                ...
                                                                <asp:RangeValidator ID="RangeValidator1" MinimumValue="0" MaximumValue="100" Type="Integer" ControlToValidate="txt_Sec_Pecentage" runat="server" ErrorMessage="Enter Values Less then equal to 100"></asp:RangeValidator>
