<%@ Page Title="" Language="C#" MasterPageFile="~/Inner.master" AutoEventWireup="true" CodeFile="MyAccount_ChangePass.aspx.cs" Inherits="MyAccount_ChangePass" %>
                                    ...
                                    <div class="profile-user-info profile-user-info-striped">
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <asp:TextBox ID="txt_OldPassword" TextMode="Password" class="col-xs-12 col-sm-6" placeholder="Enter Password" runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="None" ControlToValidate="txt_OldPassword"
                                                    runat="server" ErrorMessage="Enter current Password" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="profile-info-row">
                                            <div class="profile-info-name">
                                            ...
                                            <div class="profile-info-value">
                                                <asp:TextBox ID="txt_NewPassword" TextMode="Password" class="col-xs-12 col-sm-6" placeholder="Enter New Password"
                                                    runat="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txt_NewPassword"
                                                    runat="server" ErrorMessage="Enter new Password" ValidationGroup="Submit" Display="None"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="profile-info-row">
                                            <div class="profile-info-name">
                                            ...
                                            <div class="profile-info-value">
                                                <asp:TextBox ID="txt_ConfirmPassword" TextMode="Password" class="col-xs-12 col-sm-6" runat="server" placeholder="Enter New Password"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txt_ConfirmPassword"
                                                    runat="server" ErrorMessage="Enter confirm Password" ValidationGroup="Submit" Display="None"></asp:RequiredFieldValidator>
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                                    ErrorMessage="Passwrd Not Match" ControlToValidate="txt_ConfirmPassword" class="col-xs-12 col-sm-6" 
                                                    ControlToCompare="txt_NewPassword" ValidationGroup="Submit" 
